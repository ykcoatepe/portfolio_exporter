...
SYMBOL_MAP = {
    ...
    "GC=F": (
        Future,
        dict(symbol="GC", lastTradeDateOrContractMonth="", exchange="COMEX"),
    ),
    "SI=F": (
        Future,
        dict(symbol="SI", lastTradeDateOrContractMonth="", exchange="COMEX"),
    ),
    "CL=F": (
        Future,
        dict(symbol="CL", lastTradeDateOrContractMonth="", exchange="NYMEX"),
    ),
    "HG=F": (
        Future,
        dict(symbol="HG", lastTradeDateOrContractMonth="", exchange="COMEX"),
    ),
    "NG=F": (
        Future,
        dict(symbol="NG", lastTradeDateOrContractMonth="", exchange="NYMEX"),
    ),
}
            ...
            try:
                ...
                for s in strikes:
                    ...
                    for r in ("C", "P"):
                        ...
                        )  # let IB auto‑select tradingClass
                        try:
