...
def test_hysteresis_state_machine():
    ...
    # 1. Steady state ON
    assert evaluate_hysteresis(15, False, 0.0) == "ON"
    ...
    assert evaluate_hysteresis(31, False, 0.0) == "ON"
    # Session 2: Signal NEUTRAL
    assert evaluate_hysteresis(31, False, 0.0) == "ON"
    # Session 3: Transition to NEUTRAL
    assert evaluate_hysteresis(31, False, 0.0) == "NEUTRAL"
    ...
    assert evaluate_hysteresis(31, False, 0.0) == "OFF"
