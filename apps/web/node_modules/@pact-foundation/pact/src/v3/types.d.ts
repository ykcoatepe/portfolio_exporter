...
export declare type TemplateHeaders = {
    [header: string]: string | MatchersV3.Matcher<string> | (MatchersV3.Matcher<string> | string)[];
};
export type TemplateQuery = Record<string, string | MatchersV3.Matcher<string> | Array<string | MatchersV3.Matcher<string>>>;
