...
var UnconfiguredSynchronousMessage = /** @class */ (function () {
    function UnconfiguredSynchronousMessage(pact, interaction, opts) {
        this.pact = pact;
    ...
    UnconfiguredSynchronousMessage.prototype.usingPlugin = function (config) {
        ...
        return new SynchronousMessageWithPlugin(this.pact, this.interaction, this.opts);
    };
    UnconfiguredSynchronousMessage.prototype.withRequest = function (r) {
        return new SynchronousMessageWithRequest(this.pact, this.interaction, this.opts);
    };
...
var SynchronousMessageWithPlugin = /** @class */ (function () {
    function SynchronousMessageWithPlugin(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
    ...
    SynchronousMessageWithPlugin.prototype.withPluginContents = function (contents, contentType) {
        ...
        return new SynchronousMessageWithPluginContents(this.pact, this.interaction, this.opts);
    };
...
var SynchronousMessageWithRequest = /** @class */ (function () {
    function SynchronousMessageWithRequest(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
    SynchronousMessageWithRequest.prototype.withResponse = function (builder) {
        ...
        return new SynchronousMessageWithResponse(this.pact, this.interaction, this.opts);
    };
...
var SynchronousMessageWithResponseBuilder = /** @class */ (function () {
    ...
    SynchronousMessageWithResponseBuilder.prototype.withMetadata = function (metadata) {
        ...
        (0, ramda_1.forEachObjIndexed)(function (v, k) {
            _this.interaction.withMetadata("".concat(k), typeof v === 'string' ? v : v.getValue());
        }, metadata);
        return this;
    };
...
var SynchronousMessageWithPluginContents = /** @class */ (function () {
    function SynchronousMessageWithPluginContents(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
    ...
    config) {
        ...
        return new SynchronousMessageWithTransport(this.pact, this.interaction, this.opts, port, address);
    };
...
var SynchronousMessageWithTransport = /** @class */ (function () {
    function SynchronousMessageWithTransport(pact, interaction, opts, port, address) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
        this.port = port;
...
var SynchronousMessageWithResponse = /** @class */ (function () {
    function SynchronousMessageWithResponse(pact, interaction, opts) {
        this.pact = pact;
        this.interaction = interaction;
        this.opts = opts;
    }
...
var cleanup = function (success, pact, opts, port, transport) {
...
var executeNonTransportTest = function (pact, opts, integrationTest) { return __awaiter(void 0, void 0, void 0, function () {
    var val, error, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
