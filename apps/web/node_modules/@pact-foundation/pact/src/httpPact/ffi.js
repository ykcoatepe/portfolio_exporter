...
exports.setResponseDetails = exports.setRequestDetails = exports.setHeaders = exports.setBody = exports.setQuery = exports.setRequestMethodAndPath = exports.contentTypeFromHeaders = void 0;
var ramda_1 = require("ramda");
var matchers_1 = require("../dsl/matchers");
var logger_1 = __importDefault(require("../common/logger"));
var InteractionPart;
(function (InteractionPart) {
    InteractionPart[InteractionPart["REQUEST"] = 1] = "REQUEST";
    InteractionPart[InteractionPart["RESPONSE"] = 2] = "RESPONSE";
...
var setHeaders = function (part, interaction, headers) {
    Object.entries(headers || {}).forEach(function (_a) {
        ...
        if (Array.isArray(v)) {
            ...
            values = v.split(',').map(function (h) { return h.trim(); });
        }
        else {
            values = [v];
        }
        switch (part) {
            case InteractionPart.REQUEST:
                values.forEach(function (h, i) {
                    logger_1.default.debug("setting header request value for ".concat(h, " at index ").concat(i, " to ").concat(JSON.stringify((0, matchers_1.matcherValueOrString)(h))));
                    interaction.withRequestHeader(k, i, (0, matchers_1.matcherValueOrString)(h));
                });
                break;
            case InteractionPart.RESPONSE:
                values.forEach(function (h, i) {
                    logger_1.default.debug("setting header response value for ".concat(h, " at index ").concat(i, " to ").concat(JSON.stringify((0, matchers_1.matcherValueOrString)(h))));
                    interaction.withResponseHeader(k, i, (0, matchers_1.matcherValueOrString)(h));
                });
                break;
            default:
                break;
...
var setRequestDetails = function (interaction, req) {
    ...
    (0, exports.setBody)(InteractionPart.REQUEST, interaction, req.headers, req.body);
    (0, exports.setHeaders)(InteractionPart.REQUEST, interaction, req.headers);
...
var setResponseDetails = function (interaction, res) {
    ...
    (0, exports.setBody)(InteractionPart.RESPONSE, interaction, res.headers, res.body);
    (0, exports.setHeaders)(InteractionPart.RESPONSE, interaction, res.headers);
};
