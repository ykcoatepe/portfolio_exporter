...
export declare const setBody: (part: InteractionPart, interaction: ConsumerInteraction, headers?: Headers, body?: AnyTemplate) => void;
export declare const setHeaders: (part: InteractionPart, interaction: ConsumerInteraction, headers?: Headers) => void;
