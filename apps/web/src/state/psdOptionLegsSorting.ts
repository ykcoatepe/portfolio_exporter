...
const STORAGE_KEY = "psd.optionlegs.sorting.v1";
...
export function usePsdOptionLegsSorting(): SortingState {
  return useSyncExternalStore(subscribe, getState, getState);
}

export function setPsdOptionLegsSorting(sorting: Updater<SortingState>): void {
  setSorting(sorting);
}
